import { GitFork, Maximize2, PanelLeftClose, PanelLeftOpen, PanelRightClose, PanelRightOpen } from "lucide-react";

export function Toolbar({ leftOpen, rightOpen, setLeftOpen, setRightOpen }) {
