// 引入页可一键填充的示例需求，覆盖 3 套草案方向，让初版故事线更有变化。
...
export const INTRO_EXAMPLE = INTRO_EXAMPLES[0]; // 默认填充 / 兼容旧引用

// 生成初版方案前，AI 的随机应答语，避免每次都一模一样。
export const INTRO_DRAFT_ACKS = [
  "明白了，我先生成一版故事线方案——",
  "收到，正在根据你的意图搭建初版故事线——",
  "好的，让我把这些线索整理成一条故事线——",
  "清楚了，先给你一版可以继续打磨的结构——",
...
export const INTRO_STEPS = [
  {
    ...
    chips: ["投资人 / 决策者", "高管 / 董事会", "潜在客户", "团队 / 同事", "学术评审 / 答辩"],
  },
  {
    id: "tone",
    question: "期望的调性与节奏偏向哪种？",
    chips: ["专业严谨", "热情有感染力", "简洁高效", "数据驱动", "故事化叙事"],
  },
];
